...
export default function AboutContent() {
  ...
  return (
    <div className="flex flex-col min-h-screen bg-transparent text-primary-text font-sans">
      ...
      <main className="flex-1 w-full max-w-4xl mx-auto px-6 py-24 flex flex-col gap-16 relative z-10">
        
        {/* Founder Letter/Overview */}
        <RevealSquircle delay={0.15}>
          <div className="bg-secondary-surface p-8 md:p-12 rounded-[2.5rem] flex flex-col gap-6 relative overflow-hidden">
            ...
            <p className="text-body-base text-muted-text leading-relaxed font-semibold">
              Most digital agencies want to sell you a complex custom app or a bloated retainer package immediately. At **Sayagaa Studios**, led by **Sanika**, we believe that is a receipt for waste. Before we write code or config, we study the truth of your operations.
            </p>
            <p className="text-body-base text-muted-text leading-relaxed font-semibold">
        ...
        <div className="flex flex-col gap-8 border-t border-hairline/60 pt-12">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
            {philosophyPoints.map((item) => (
              <div key={item.title} className="p-6 bg-secondary-surface rounded-2xl flex flex-col gap-2 relative overflow-hidden">
        ...
        <div className="flex flex-col gap-8 border-t border-hairline/60 pt-12">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
            {industriesKnown.map((item) => (
              <div key={item.area} className="p-6 bg-secondary-surface rounded-2xl flex flex-col gap-2 relative overflow-hidden">
